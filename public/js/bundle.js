...
},{"./public/js/accounts.js":4,"./public/js/datepickr.js":5,"./public/js/loghistory.js":6,"./public/js/logs.js":7,"./public/js/nav.js":8,"./public/js/sorttable.js":9,"moment":2,"whatwg-fetch":3}],2:[function(require,module,exports){
//! moment.js
//! version : 2.17.1
...
var datepickr = function datepickr(selector, config) {
    'use strict';
...
datepickr.init = function (element, instanceConfig) {
    ...
    date = {
        current: {
            ...
            month: {
                ...
                string: function string(shorthand) {
    ...
    formatDate = function formatDate(dateFormat, milliseconds) {
        var formattedDate = '',
    ...
    isSpecificDay = function isSpecificDay(day, month, year, comparison) {
    ...
    calendarClick = function calendarClick(event) {
    ...
    getOpenEvent = function getOpenEvent() {
...
datepickr.init.prototype = {
    ...
    addEventListener: function addEventListener(element, type, listener, useCapture) {
        element.addEventListener(type, listener, useCapture);
    },
    removeEventListener: function removeEventListener(element, type, listener, useCapture) {
...
if (save) {
  save.addEventListener('click', function () {
    ...
    if (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/Windows Phone/i)) {
      ...
      xhrPromise(f).then(function (res) {
...
if (update) {
  update.addEventListener('click', function () {
    ...
    if (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/Windows Phone/i)) {
      ...
      xhrPromiseUpdate(f).then(function (res) {
